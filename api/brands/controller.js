...
const AddBrand = async (req, res) => {
    const { BrandName, BrandLogo, BrandImage } = req.body
    if (!BrandName || !BrandImage) {
        ...
        try {
            ...
            console.log("DB Connected in add")
            ...
            if (checkExisting) {
                ...
                await Brand.create({ BrandName, BrandLogo, BrandImage })
...
const updateBrand = async (req, res) => {
    const { _id, BrandName, BrandLogo, BrandImage } = req.body;

    const filter = { _id };
    const update = { BrandName, BrandLogo, BrandImage };
